                            ...
                            <tr>
                                ...
                                <td align="right">
                                    ...
                                    <a class="tooltip-default" style="color:#aaa;cursor:pointer;" data-toggle="tooltip"
                                       ...
                                       onclick="confirm_modal('<?php echo base_url(); ?>index.php?client/project_file/delete/<?php echo $row2['project_file_id']; ?>', '<?php echo base_url(); ?>index.php?client/reload_projectroom_file_list/<?php echo $project_code; ?>');">
