	...
	<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <div class="tab-content">
                    ...
                    <?php echo form_open(base_url() . 'index.php?staff/project_file/upload/' . $row['project_code'] , array(
                    ...
                    <div class="tab-pane" id="profile">
                        ...
                        <?php echo form_open(base_url() . 'index.php?staff/project_file/dropzone_upload/' . $row['project_code'] , array('class' => 'dropzone' , 'id' => 'dropzone_example'));?>
                            <div class="fallback">
                    ...
                    <div class="tab-pane" id="messages">
                        <?php echo form_open(base_url() . 'index.php?staff/project_file/dropbox_upload/' . $row['project_code'] , array(
        ...
        <div class="panel panel-primary" data-collapsed="0">
            <div class="panel-heading">
                ...
                <?php if ($number_of_staffs > 0):?>
                    <a href="<?php echo base_url();?>index.php?staff/projectroom/edit/<?php echo $project_code;?>" 
                        class="btn btn-default tooltip-primary" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('add_staff');?>">
                        <i class="entypo-pencil"></i>
                    </a>
                <?php endif;?>
                </div>
...
<script>
    ...
    var post_refresh_url    =   '<?php echo base_url();?>index.php?staff/reload_projectroom_file_list/<?php echo $project_code;?>';
</script>
...
function reload_data(url)
{
    $.ajax({
        ...
        success: function(response)
        {
            ...
            // calling the dropzone back again after response
