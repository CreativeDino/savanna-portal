    ...
    <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?staff/project_task/edit/'.$param3, array('class' => 'form-horizontal form-groups-bordered validate project-task-edit', 'enctype' => 'multipart/form-data')); ?>
...
<script>
    ...
    var post_refresh_url = '<?php echo base_url(); ?>index.php?staff/reload_projectroom_task/<?php echo $param2; ?>';
</script>
