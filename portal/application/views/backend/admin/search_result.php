		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				...
				<div class="panel-options">
					<a href="<?php echo base_url();?>index.php?admin/staff" class="btn btn-default tooltip-primary" 
	...
	<div class="col-sm-6">
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				...
				<div class="panel-options">
					<a href="<?php echo base_url();?>index.php?admin/client" class="btn btn-default tooltip-primary" 
	...
	<div class="col-sm-6">
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				...
				<div class="panel-options">
					<a href="<?php echo base_url();?>index.php?admin/team_task" class="btn btn-default tooltip-primary" 
	...
	<div class="col-sm-6">
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				...
				<div class="panel-options">
					<a href="<?php echo base_url();?>index.php?admin/support_ticket" class="btn btn-default tooltip-primary" 
