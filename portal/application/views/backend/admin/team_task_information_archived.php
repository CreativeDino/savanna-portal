	...
	<div class="panel panel-primary" data-collapsed="0">
		...
		<div class="panel-heading">
			...
			<div class="panel-options">
				<a href="#" class="btn btn-default btn-xs tooltip-primary" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit_task');?>"
                    onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/team_task_edit_archived/<?php echo $row['team_task_id']; ?>');">
                    <i class="entypo-pencil"></i>
                </a>

                <a href="#" class="btn btn-default btn-xs tooltip-primary" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('delete_this_task');?>"
...
<div class="col-md-3">
    ...
    <div class="alert alert-warning">
        ...
        <a href="<?php echo base_url();?>index.php?admin/team_task/remove_from_archive/<?php echo $row['team_task_id'];?>" 
            class="tooltip-primary pull-right" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('remove_from_archive');?>">
	...
	<div class="panel panel-primary" data-collapsed="0">
        <div class="panel-heading">
            ...
            <?php if ($number_of_staffs > 0):?>
            	<a href="#" class="btn btn-default tooltip-primary" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('add_staff');?>"
            		onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/team_task_edit_archived/<?php echo $row['team_task_id']; ?>');">
        ...
        if ($number_of_staffs < 1):
    		...
    		<a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/team_task_edit_archived/<?php echo $row['team_task_id']; ?>');">
...
<script>
    ...
    function show_response_on_task_note_save(responseText, statusText, xhr, $form) {
        ...
        reload_team_task_information_archived('<?php echo base_url(); ?>index.php?admin/reload_team_task_information_archived/<?php echo $team_task_id; ?>');
