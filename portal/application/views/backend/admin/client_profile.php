...
<div class="tab-content" style="padding:0px;">
    ...
    <div class="tab-pane" id="project">
        <table class="table table-striped">
            <tbody>
                <?php 
                    $query = $this->db->get_where('project' , array('client_id' => $param2));
                    if ($query->num_rows() > 0):
                        $client_projects = $query->result_array();
                        foreach ($client_projects as $row2):
                ?>
                <tr>
                    <td width="93%">
                        <i class="entypo-dot"></i> 
            ...
            <?php if ($query->num_rows() < 1):?>
                <h4 class="text-center" style="color: #ccc;">
                    <?php echo get_phrase('no_project_from_this_client');?>
                </h4>
            <?php endif;?>
