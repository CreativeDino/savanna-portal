	...
	<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <div class="tab-content">
                    ...
                    <?php echo form_open(base_url() . 'index.php?admin/project_file/upload/' . $row['project_code'] , array(
                    ...
                    <div class="tab-pane" id="profile">
                        ...
                        <?php echo form_open(base_url() . 'index.php?admin/project_file/dropzone_upload/' . $row['project_code'] , array('class' => 'dropzone' , 'id' => 'dropzone_example'));?>
                            <div class="fallback">
                    ...
                    <div class="tab-pane" id="messages">
                        <?php echo form_open(base_url() . 'index.php?admin/project_file/dropbox_upload/' . $row['project_code'] , array(
