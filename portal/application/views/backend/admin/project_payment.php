...
<div class="col-md-7">
    ...
    -webkit-transform: rotate(90deg); /* Chrome, Safari, Opera */ transform: rotate(90deg);">
                                    ...
                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu" style="text-align:left;">
                                        ...
                                        <li>
                                            <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/project_milestone/delete/<?php echo $row2['project_milestone_id'];?>' , '<?php echo base_url(); ?>index.php?admin/reload_projectroom_payment/<?php echo $row2['project_code']; ?>')">
